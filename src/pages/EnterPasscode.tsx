          ...
          buttons={[
            {
              text: "OK",
              handler: () => {
                console.log("Navigating to /Tultoladmin/home via alert OK");
                try { history.push("/Tultoladmin/home"); } catch (error) { console.error("Navigation failed:", error); }
              },
            },
          ]}
          onDidDismiss={() => {
            if (showWelcome) {
              console.log("Navigating to /Tultoladmin/home via alert dismiss");
              try { history.push("/Tultoladmin/home"); } catch (error) { console.error("Navigation failed:", error); }
            }
          }}
        />
